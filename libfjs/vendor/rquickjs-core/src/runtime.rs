...
/// The type of the background JavaScript job error handler.
#[cfg(feature = "futures")]
#[cfg(not(feature = "parallel"))]
pub type JobErrorHandler = Box<dyn for<'a> Fn(Ctx<'a>) + 'static>;
/// The type of the background JavaScript job error handler.
#[cfg(feature = "futures")]
#[cfg(feature = "parallel")]
pub type JobErrorHandler = Box<dyn for<'a> Fn(Ctx<'a>) + Send + 'static>;
